...
<html lang="en">
  ...
  <style>
    body{
    background-image: url(../src/images/000.jpeg);
    background-color: #c9c9e974;
}
.fdiv{
...
.fpara{
    background-image: url(../src/images/fob.jpg);
    color: #f7f7fe;
}
  </style>
...
<!--navigation bar (end)-->
  <div class="fdiv">
    <h2>How To Vote</h2>
    <ol>
    <li>First you must enter your correct information and register to the system by using registration page.</li>
    <li>Then move to sign in page and sign in to the system correctly. Then move to the page shown as "vote page".</li>
    <li>There are two selection buttons to choose singing category and dancing category and you have to select the competition category of the contestant you want to vote for and then cast your vote.</li>
    </ol>
    <br>
</div>
<br>
...
<div class="fdiv">
    ...
    <ol>
        <li>First you must sign in to the system.</li>
        <li>Then go to the page called "Buy Tickets".</li>
        <li>To buy tickets, there are two buttons indicating the divisions in which the contestants are competing, which means that you should indicate the ticket related to which competition division you are buying. Then select the required number of tickets and use a payment method shown there and enter the correct information and make the payment.</li>
    </ol> 
    <br>
</div>
<br>
<br>
<br>
<h2 class="fpara">IF YOU NEED FURTHER CLARIFICATION</h2>
</body>
